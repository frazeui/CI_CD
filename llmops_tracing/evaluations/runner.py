...
def fake_llm(transaction:dict)->dict:
    ...
    if amount>5000:return {"risk_level":"HIGH","decision":"BLOCK"}
    elif country!="UAE":return {"risk_level":"MEDIUM","decision":"REVIEW"}
    elif tx_count>3:return {"risk_level":"HIGH","decision":"BLOCK"}
    else: return {"risk_level":"LOW","decision":"APPROVE"}
